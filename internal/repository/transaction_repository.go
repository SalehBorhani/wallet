...
type TransactionRepository interface {
	...
	Save(ctx context.Context, tx *gorm.DB, transaction *model.Transaction) (*model.Transaction, error)
...
func (r *transactionRepository) Begin(ctx context.Context) *gorm.DB {
...
func (r *transactionRepository) Save(ctx context.Context, tx *gorm.DB, transaction *model.Transaction) (*model.Transaction, error) {
